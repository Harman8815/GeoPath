    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-10 gap-4">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="space-y-4 p-4 rounded-2xl bg-[#16181d]/80 border border-zinc-800 text-xs">
            {/* Algorithm Selector */}
            ...
            <div className="space-y-1">
              ...
              <div className="flex flex-col gap-1.5">
                <button
                  ...
                  className="h-9 rounded-xl bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-300 hover:text-white font-medium text-[11px] transition-all cursor-pointer"
                ...
                <button
                  onClick={() => handleApplyMaze('random')}
                  className="h-9 rounded-xl bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-300 hover:text-white font-medium text-[11px] transition-all cursor-pointer"
                  id="maze-random-btn"
                >
                  Random Walls
          ...
          {/* Interactive Tool Placement Bar */}
          <div className="p-3 rounded-xl bg-[#121620]/60 border border-slate-800 text-xs">
            <span className="text-slate-400 font-semibold text-[11px] uppercase block mb-2">Active Tool:</span>
            <div className="flex flex-col gap-1.5">
              <button
                onClick={() => setToolMode('wall')}
                className={`w-full py-1.5 rounded font-medium transition-all cursor-pointer ${
                  toolMode === 'wall' ? 'bg-slate-800 text-white border border-slate-700' : 'text-slate-400 hover:text-slate-200 border border-transparent'
                }`}
                id="tool-wall-btn"
              >
                █ Wall Block
              ...
              <button
                ...
                className={`w-full py-1.5 rounded font-medium transition-all cursor-pointer ${
                  toolMode === 'weight' ? 'bg-amber-950 text-amber-300 border border-amber-800/60' : 'text-slate-400 hover:text-slate-200 border border-transparent'
                }`}
                id="tool-weight-btn"
              >
                ≈ Swamp Terrain (5x)
